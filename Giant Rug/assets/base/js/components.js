	...
	return {
		...
		init: function () {
			...
			if (App.getViewPort().width < App.getBreakpoint('md')) { // mpbile mode
				...
				$('body').on('click', '.c-compare-toggler', function (e) {
					e.preventDefault();
					e.stopPropagation();
					$('body').toggleClass("c-header-compare-shown");
				});

				$('body').on('click', function (e) {
					if (!compare.is(e.target) && compare.has(e.target).length === 0) {
						$('body').removeClass('c-header-compare-shown');
					}
				});
			} else { // desktop
				...
				$('body').on('hover', '.c-compare-toggler, .c-compare-menu', function (e) {
					$('body').addClass("c-header-compare-shown");
				});

				$('body').on('hover', '.c-mega-menu > .navbar-nav > li:not(.c-compare-toggler-wrapper)', function (e) {
					$('body').removeClass("c-header-compare-shown");
				});

				$('body').on('mouseleave', '.c-compare-menu', function (e) {
					$('body').removeClass("c-header-compare-shown");
				});
			}
		}
